...
const ICON_PATHS = {
  ...
  clip: (
    <path d="m21.4 11-9.2 9.2a6 6 0 0 1-8.5-8.5l8.6-8.5a4 4 0 0 1 5.6 5.6l-8.5 8.6a2 2 0 0 1-2.9-2.9l8.5-8.4" />
  ),
  check: <path d="M20 6 9 17l-5-5" />,
  close: <path d="M18 6 6 18M6 6l12 12" />,
  spark: (
    <path d="M12 3.5 13.9 9l5.6 1.9-5.6 1.9L12 18.5l-1.9-5.7-5.6-1.9L10.1 9zM19 3v4M21 5h-4" />
  ),
