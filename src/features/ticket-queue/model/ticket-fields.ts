...
export const urgencyText = (ticket: Ticket) => (isClassifying(ticket) ? CLASSIFYING : ticket.urgency_label);

export const complexityText = (ticket: Ticket) => (isClassifying(ticket) ? CLASSIFYING : ticket.complexity_label);
