import { DIMENSION_LABELS, DIMENSION_OBJECT_LABELS, DIMENSIONS, type Dimension } from '@/shared/config/labels';
...
export function ClassificationFields({ ticket, dictionaries, disabled, onChange }: ClassificationFieldsProps) {
