...
export function NotificationsPage({ notifications, timezone, onOpenTicket }: NotificationsPageProps) {
    ...
    return (
        <div className="notifications-page">
            <PageHeader title="Уведомления">
                {unread > 0 ? <span className="notifications-page__count">Не прочитано: {unread}</span> : null}
            </PageHeader>
