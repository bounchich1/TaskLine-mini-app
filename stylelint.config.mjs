...
export default {
    ...
    rules: {
        'selector-class-pattern': [BEM, { message: 'Class names follow BEM: block__element--modifier.' }],
        'max-nesting-depth': 3,
        'selector-max-compound-selectors': 3,
        'selector-max-id': 0,
        'value-keyword-case': ['lower', { ignoreProperties: ['$font-family-base', '$font-family-mono'] }],
