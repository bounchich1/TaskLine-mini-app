...
export const DICTIONARIES = [
  ...
  { dimension: 'urgency', code: 'critical', label: 'Критическая', rank: 3, active: true, version: 1 },
...
export const AUDIT = [
  { id: 'au1', action: 'admin.settings', object_id: 'org', created_at: '2026-03-01T08:00:00Z' },
];
